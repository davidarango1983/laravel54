                                ...
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('/update') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="name" type="text" class="form-control" name="name" value="<?php if ((old('name')!=null)){echo old('name');}else{echo $usuario->name;} ?>">
                                    ...
                                    <div class="form-group{{ $errors->has('apellido') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name" type="text" class="form-control" name="apellido" value="<?php if ((old('name')!=null)){echo old('last_name');}else{echo $usuario->last_name;} ?>">
                                    ...
                                    <div class="form-group{{ $errors->has('apellido') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="fecha" type="text" class="form-control" name="fecha" value="<?php if ((old('fecha')!=null)){echo (old('fecha'));}else{echo ($usuario->fecha_nac);} ?>">
                                    ...
                                    <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="telefono" type="tel" class="form-control" name="telefono" value="<?php if ((old('name')!=null)){echo old('telefono');}else{echo $usuario->telefono;}?>">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="email" type="email" class="form-control" name="email" value="<?php if ((old('email')!=null)){echo old('email');}else{echo $usuario->email;}?>">
